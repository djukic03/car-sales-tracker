...
public class InvoiceItemsTableForm extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvoiceItemsTableForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InvoiceItemsTableForm dialog = new InvoiceItemsTableForm(new javax.swing.JFrame(), true);
